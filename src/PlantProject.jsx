...
import videoPlantProjectDemonstration from "./assets/images/videoPlantProjectHardwareDemo.mp4";
import videoPlantProjectAppDemonstration from "./assets/images/videoPlantProjectAppDemo.mp4";
        ...
        <div>
            <div className = "mainContainer">
                ...
                <div className="projectContentContainer">
                    ...
                    <video controls className = "videoPlantProjectAppDemo">
                        <source src={videoPlantProjectAppDemonstration} type="video/mp4"/>
                    </video>
