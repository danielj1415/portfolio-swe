        ...
        <div>
            ...
            <div className="mainContainer">
                ...
                <div className="aboutMeFirstSectionContainer">
                    <div className="aboutMeFirstSectionText">
                        ...
                        <div className="aboutMeParagraphContainer">
                            <p className="aboutMeParagraph space">I am a software engineer based in the Los Angeles
                                area. My journey in coding began back in 2019 with a simple Hello World in C++ and has
                                now evolved to more complex programs.</p>
                            <p className="aboutMeParagraph">I am passionate about bringing interface designs to life in
                                code and connecting the front-end part of applications to back-end databases and
                                technologies. In addition, I am experienced in product design to create beautiful
                                user-interfaces for websites and mobile applications.</p>
                        </div>
                ...
                <div className="aboutMeSecondSectionContainer">
                    ...
                    <p className="aboutMeParagraph smallerText"><strong>Gym 💪🏻:</strong> Going to the gym is part of my
                        daily routine and is a way to work on myself physically. I am able to bench 250 and squat 315
                        pounds. </p>
                    <p className="aboutMeParagraph middle smallerText"><strong>Games 🎮:</strong> In my free time, I love
                        to pick up my controller and play games with people. Currently, I am playing Super Smash Bros
                        Ultimate and Pokemon Violet. </p>
                    <p className="aboutMeParagraph smallerText"><strong>Piano 🎹:</strong> I love to play songs from my
                        favorite movies and games. Also, I currently play piano for my church’s youth ministry. </p>
                </div>
